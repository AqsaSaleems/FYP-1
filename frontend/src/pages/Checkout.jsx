...
function DesignView({ design }) {
  ...
  return (
    <div style={{background:'#f9f9f9', padding:'8px', borderRadius:'4px'}}>
      ...
      <div style={{fontSize:'12px', marginBottom:'4px'}}>
        <strong>Sticker:</strong> {stickerSrc ? <img src={stickerSrc} alt="sticker" style={{display:'inline-block', width:'32px', height:'32px', marginLeft:'4px', border:'1px solid #ccc'}} /> : (design.selectedSticker ? <span style={{fontSize:'10px', color:'#666'}}> Sticker (preview not available)</span> : ' None')}
      </div>
              ...
              return (
                <div key={idx} style={{border:'1px solid #ddd', borderRadius:'8px', padding:'12px', background:'#fafafa'}}>
                  <div style={{display:'flex', gap:'12px', marginBottom:'12px'}}>
                    <img src={it.frontImage || it.image || 'https://via.placeholder.com/80'} alt={it.name} style={{width:100, height:100, objectFit:'cover', borderRadius:'6px'}} />
                    <div style={{flex:1}}>
                  ...
                  return (
                    <div key={idx} style={{marginBottom:14, paddingBottom:12, borderBottom:'1px solid #f0f0f0'}}>
                      <div style={{display:'flex', gap:12, marginBottom:10}}>
                        <img src={it.frontImage || it.image || 'https://via.placeholder.com/80'} alt={it.name} style={{width:80, height:80, objectFit:'cover', borderRadius:'4px', border:'1px solid #ddd'}} />
                      ...
                      {(front || back) && (
                        <div style={{background:'#fafafa', padding:10, borderRadius:'4px', marginTop:8, fontSize:11}}>
                          <div style={{fontWeight:'bold', marginBottom:8, color:'#333'}}>✓ Design Customizations</div>
                            ...
                            {front && (
                              <div>
                                ...
                                <div style={{fontSize:'10px', color:'#666', lineHeight:'1.4'}}>
                                  ...
                                  {(front.logo || front.selectedSticker) && <div>With: {front.logo ? 'Logo' : ''} {front.logo && front.selectedSticker ? '& ' : ''}{front.selectedSticker ? 'Sticker' : ''}</div>}
                                </div>
                              </div>
                            )}
                            {back && (
                              <div>
                                ...
                                <div style={{fontSize:'10px', color:'#666', lineHeight:'1.4'}}>
                                  ...
                                  {(back.logo || back.selectedSticker) && <div>With: {back.logo ? 'Logo' : ''} {back.logo && back.selectedSticker ? '& ' : ''}{back.selectedSticker ? 'Sticker' : ''}</div>}
                                </div>
                              </div>
                            )}
                          </div>
