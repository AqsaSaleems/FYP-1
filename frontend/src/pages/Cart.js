        ...
        <div style={styles.cartItemsSection}>
          {cartItems.length === 0 ? (
            ...
            cartItems.map((item, index) => (
              ...
              >
                <img
                  src={item.frontImage || item.image || "https://via.placeholder.com/100"}
                        ...
                        try {
                          ...
                          return (
                            <div>
                              ...
                              {front?.selectedSticker && <p style={styles.customDetail}>✨ Front Sticker: {front.selectedSticker.name || front.selectedSticker}</p>}
                              {back && (
                                <>
                                  ...
                                  {back.selectedSticker && <p style={styles.customDetail}>✨ Back Sticker: {back.selectedSticker.name || back.selectedSticker}</p>}
                                </>
                              )}
